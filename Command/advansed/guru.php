...
/**
 *
 * В этом примере паттерн Команда применяется для построения очереди из вызовов скрейпинга (скачивания)
 * отдельных страниц сайта IMDB и выполнения их один за другим. Сама очередь хранится в базе данных, которая помогает
 * не терять команды между запусками скрипта.
 *
 */
